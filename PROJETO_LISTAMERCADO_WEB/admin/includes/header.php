<?php session_start(); ?>
<?php
   if(!isset($_SESSION['nome_adm'])) header("location: login.php");  
?>
	              ...
	              <div class="navbar navbar-inverse" role="banner">
	                  <nav class="collapse navbar-collapse bs-navbar-collapse navbar-right" role="navigation">
	                    <ul class="nav navbar-nav">
	                      <li class="dropdown">
	                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo $_SESSION['nome_adm']; ?> <b class="caret"></b></a>
                ...
                <ul class="nav">
					...
					<li class="submenu">
                      ...
                      <i class="glyphicon glyphicon-user"></i>Serviços
                         ...
                         <!-- Sub menu -->
                         <ul>
							<li><a href="form-servico.php"><i class="icon-inbox"></i>Cadastrar Serviços </a></li>
							<li><a href="servico-lista.php">Serviços Cadastrados</a></li>
							<li><a href="servico-form-pesquisa-nome.php">Pesquisar Serviços</a></li> 
                        </ul>
                    </li>
